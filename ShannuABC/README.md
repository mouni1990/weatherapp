...
A fun kids learning app to learn **alphabets** (A–Z) and **numbers** (1–10) with **tracing** practice.
...
2. From the project folder run: `python3 -m http.server 8080` and go to http://localhost:8080
